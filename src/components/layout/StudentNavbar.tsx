    ...
    <nav className="h-16 bg-white border-b border-border flex items-center px-6 gap-5 sticky top-0 z-10">
      <div className="flex items-center gap-2.5">
        ...
        <div className="leading-tight">
          ...
          <div className="text-[11px] text-muted">St. Andrews Institute</div>
        </div>
      </div>
      ...
      <Link
        href="/notifications"
        className="w-10 h-10 rounded-[10px] grid place-items-center text-muted hover:bg-surface-2 hover:text-ink relative"
      >
        <Bell size={18} />
